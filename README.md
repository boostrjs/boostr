...
- `html`: An object allowing you to customize the `index.html` file automatically generated by Boostr. See ["Autogenerated `index.hml` File"](#autogenerated-indexhml-file) for details.
- `stages`:
